...
- **PDFs (`test_assets/pdfs/`)**: Individual PDF copies for testing document-to-image conversion.
...
4. **PDF Import**: Drag any PDF file from `test_assets/pdfs/` into the app. It will automatically convert the first page into a high-resolution sequence frame.
